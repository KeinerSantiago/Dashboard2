...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="ingresarnotas2.php" class="boton_1" ><style type="text/css">
  .boton_1{
...
</style>INGRESAR NOTAS</a></th>

        <th ><form method="get" ><br>
            <label for="busqueda">BUSCAR</label>
            <input  type="text" name="busqueda" id="busqueda" class="form-control mb-3" class="btn_search" placeholder="Id, Nombre, Curso">
         ...
         <div class="col-md-8">
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                                    <tr>
                                        <td style="font-family:inherit; font-size: 9">Id Periodo Academico</td>
                                        <td style="font-family:inherit; font-size: 9">Id Estudiante</td>
                                        <td style="font-family:inherit; font-size: 9">Id Asignatura</td>
                                        <td style="font-family:inherit; font-size: 9">Valoracion Nota</td>
                                        <td style="font-family:inherit; font-size: 9">Id Notas</td>
                                        <td style="font-family:inherit; font-size: 9">Id logro</td>
                                ...
                                <tbody>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_per_aca']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_est']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_asig']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['v_nota']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_notas']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_logro']?></FONT></td>
                                                <th style="font-family:monospace; font-size: 10",color:darkred><a href="actualizarnotas2.php?id_per_aca=<?php echo $row['id_per_aca'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:monospace; font-size: 10",color:skyblue><a href="eliminarnotas2.php?id_per_aca=<?php echo $row['id_per_aca'] ?>" class="btn btn-danger">Eliminar</a></th>  
                                             </tr>                                         
