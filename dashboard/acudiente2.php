        ...
        <div class="row">
            <div class="barra-lateral col-12 col-sm-auto">
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
                    ...
                    <a href="cursos.php"><i class="fa fa-copyright"></i><span>Curso</span></a>
...
<table width="100%">
    <tr>       
        ...
        <th >
            <h1>Lista de Acudiente</h1>
        </th>

        <th><label for="busqueda"></label><br><a href="insertaracudiente2.php" class="boton_1" ><style type="text/css">
  .boton_1{
...
</style>INGRESAR ACUDIENTE</a></th>

        <th ><form method="get" ><br>
            <label for="busqueda">BUSCAR</label>
            <input  type="text" name="busqueda" id="busqueda" class="form-control mb-3" class="btn_search" placeholder="Id, Nombre, parentesco">
         ...
         <div class="col-md-8">
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                    <tr>
                                        <td style="font-family:serif; font-size: 9">Id_Acudiente</td>
                                        <td style="font-family:serif; font-size: 9">Tipo_documento</td>
                                        <td style="font-family:serif; font-size: 9">Nombres</td>
                                        <td style="font-family:serif; font-size: 9">Apellidos</td>
                                        <td style="font-family:serif; font-size: 9">Parentesco</td>
                                        <td style="font-family:serif; font-size: 9">Direccion</td>
                                        <td style="font-family:serif; font-size: 9">Id_Pais</td>
                                        <td style="font-family:serif; font-size: 9">Id_Ciudad</td>
                                        <td style="font-family:serif; font-size: 9">Telefono</td>
                                        <td style="font-family:serif; font-size: 9">Id_Estudiante</td>
                                        <td style="font-family:serif; font-size: 9">Editar</td>
                                        <td style="font-family:serif; font-size: 9">Eliminar</td>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                <td><FONT COLOR="#330000"><?php  echo $row['id_acud']?></FONT></td>
                                                <td><FONT COLOR="#330000"><?php  echo $row['tipo_doc']?></FONT></td>
                                                <td><FONT COLOR="#330000"><?php  echo $row['nom_acu']?></FONT></td>
                                                <td><FONT COLOR="#330000"><?php  echo $row['apel_acu']?></FONT></td>   
                                                <td><FONT COLOR="#330000"><?php  echo $row['parentesco']?></FONT></td>
                                                <td><FONT COLOR="#330000"><?php  echo $row['dir_acu']?></FONT></td>
                                                <th><FONT COLOR="#330000"><?php  echo $row['id_pais']?></FONT></th>
                                                <th><FONT COLOR="#330000"><?php  echo $row['id_ciu']?></FONT></th>
                                                <td><FONT COLOR="#330000"><?php  echo $row['tel_acu']?></FONT></td>
                                                <th><FONT COLOR="#330000"><?php  echo $row['id_est']?></FONT></th>
                                                <th style="font-family:hobo; font-size: 10",color:darkred><a href="actualizaracu2.php?id_acud=<?php echo $row['id_acud'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:hobo; font-size: 10",color:skyblue><a href="eliminaracu2.php?id_acud=<?php echo $row['id_acud'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
