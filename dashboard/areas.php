...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="ingresararea.php" class="boton_1" ><style type="text/css">
  .boton_1{
             ...
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                                    <tr>
                                        ...
                                        <td style="font-family:initial; font-size: 9">Nombre Area</td>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><FONT COLOR="#000000"><?php  echo $row['nom_area']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['est_area']?></FONT></td>
                                                <th style="font-family:monospace; font-size: 10",color:darkred><a href="actualizararea.php?id_area=<?php echo $row['id_area'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:monospace; font-size: 10",color:skyblue><a href="eliminararea.php?id_area=<?php echo $row['id_area'] ?>" class="btn btn-danger">Eliminar</a></th>  
                                             </tr>                                         
