...
?>
   <title> CRUD_AÑO_ACADEMICO </title>
        <meta charset="UTF-8">
...
<table width="100%">
    <tr>       
        ...
        <th >
            <h1>Lista de Año Academico</h1>
        </th>

        <th><label for="busqueda"></label><br><a href="insertaraca2.php" class="boton_1" ><style type="text/css">
  .boton_1{
             ...
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                    <tr>
                                        ...
                                        <td style="font-family:inherit; font-size: 9">Nombre Año</td>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><FONT COLOR="#000000"><?php  echo $row['nom_ano_acad']?></FONT></td>
                                                   
                                                <th style="font-family:inherit; font-size: 10",color:darkred><a href="actualizaraca.php?id_ano_acad=<?php echo $row['id_ano_acad'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:inherit; font-size: 10",color:skyblue><a href="eliminaraca.php?id_ano_acad=<?php echo $row['id_ano_acad'] ?>" class="btn btn-danger">Eliminar</a></th>  
