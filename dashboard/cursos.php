...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="ingresarcurso.php" class="boton_1" ><style type="text/css">
  .boton_1{
                ...
                <thead class="table-success table-striped" >
                                ...
                                <thead class="table-success table-striped">
                                    <tr>
                                        ...
                                        <td style="font-family:inherit; font-size: 9">Nombre Curso</td>
                                        <td style="font-family:inherit; font-size: 9">Id año Academico</td>
                                        <td style="font-family:inherit; font-size: 9">Id_doc</td>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><FONT COLOR="#000000"><?php  echo $row['nom_curso']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_ano_acad']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_doc']?></FONT></td>    
                                                <th style="font-family:hobo; font-size: 10",color:darkred><a href="actualizarcurso.php?id_curso=<?php echo $row['id_curso'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:hobo; font-size: 10",color:skyblue><a href="eliminarcurso.php?id_curso=<?php echo $row['id_curso'] ?>" class="btn btn-danger">Eliminar</a></th>  
