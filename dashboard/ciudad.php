...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="insertarciu2.php" class="boton_1" ><style type="text/css">
  .boton_1{
             ...
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                    <tr>
                                        ...
                                        <td style="font-family:inherit; font-size: 9">Nombre Ciudad</td>
                                ...
                                <tbody>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_ciu']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['nom_ciu']?></FONT></td>
                                                   
                                                <th style="font-family:inherit; font-size: 10",color:darkred><a href="actualizarciudad.php?id_ciu=<?php echo $row['id_ciu'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:inherit; font-size: 10",color:skyblue><a href="eliminarciu.php?id_ciu=<?php echo $row['id_ciu'] ?>" class="btn btn-danger">Eliminar</a></th>  
