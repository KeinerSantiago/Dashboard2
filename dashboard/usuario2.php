...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="insertarusuarios2.php" class="boton_1" ><style type="text/css">
  .boton_1{
...
</style>INGRESAR PAIS</a></th>

        <th ><form method="get" ><br>
            <label for="busqueda">BUSCAR</label>
            <input  type="text" name="busqueda" id="busqueda" class="form-control mb-3" class="btn_search" placeholder="Id, Nombre">
         ...
         <div class="col-md-8">
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                    <tr>
                                        <td style="font-family:inherit; font-size: 9">Id Usuario</td>
                                        <td style="font-family:inherit; font-size: 9">Nombre Usuario</td>
                                        <td style="font-family:inherit; font-size: 9">Apellidos Usuario</td>
                                        <td style="font-family:inherit; font-size: 9">Password</td>
                                        <td style="font-family:inherit; font-size: 9">Periodo</td>
                                        <td style="font-family:inherit; font-size: 9">Estado</td>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th style="font-family:hobo; font-size: 10",color:darkred><a href="actualizarusuario2.php?id_usu=<?php echo $row['id_usu']?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:hobo; font-size: 10",color:skyblue><a href="eliminarusuario2.php?id_usu=<?php echo $row['id_usu'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
