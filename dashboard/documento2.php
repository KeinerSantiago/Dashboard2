...
<div align="center">
   <title> CRUD_TIPO_DOCUMENTO</title>
        <meta charset="UTF-8">
...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="insertardocumento2.php" class="boton_1" ><style type="text/css">
  .boton_1{
...
</style>INGRESAR TIPO DOCUMENTO</a></th>
         ...
         <div class="col-md-8">
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                    <tr>
                                        <td style="font-family:cursive; font-size: 9">Tipo de Documento</td>
                                        <td style="font-family:cursive; font-size: 9">Nombre de Documento</td>
                                        <td style="font-family:cursive; font-size: 9">Editar</td>
                                        <td style="font-family:cursive; font-size: 9">Eliminar</td>
                                    </tr>
                                </thead>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th style="font-family:hobo; font-size: 10",color:darkred><a href="actualizartipodoc2.php?tipo_doc=<?php echo $row['tipo_doc'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:hobo; font-size: 10",color:skyblue><a href="eliminartipodoc2.php?tipo_doc=<?php echo $row['tipo_doc'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
