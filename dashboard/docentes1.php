...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="insertarestudiantes.php" class="boton_1" ><style type="text/css">
  .boton_1{
         ...
         <div class="table-container">
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                    <tr>
                                        <td style="font-family:inherit; font-size: 9">Id Docente</td>
                                        <td style="font-family:inherit; font-size: 9">Tipo Doc</td>
                                        ...
                                        <td style="font-family:inherit; font-size: 9">Id Asig</td>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th style="font-family:hobo; font-size: 10",color:skyblue><a href="eliminardoc.php?id_doc=<?php echo $row['id_doc'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
