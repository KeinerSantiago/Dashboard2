...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="insertarperi2.php" class="boton_1" ><style type="text/css">
  .boton_1{
             ...
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                    <tr>
                                        ...
                                        <td style="font-family:inherit; font-size: 9">Nombre Periodo</td>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><FONT COLOR="#000000"><?php  echo $row['nom_per']?></FONT></td>
                                                   
                                                <th style="font-family:inherit; font-size: 10",color:darkred><a href="actualizarperi.php?id_per_aca=<?php echo $row['id_per_aca'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:inherit; font-size: 10",color:skyblue><a href="eliminarperi.php?id_per_aca=<?php echo $row['id_per_aca'] ?>" class="btn btn-danger">Eliminar</a></th>  
