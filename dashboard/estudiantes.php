        ...
        <div class="row">
            <div class="barra-lateral col-12 col-sm-auto">
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
                    ...
                    <a href="ano_academico.php"><i class="fa fa-calendar"></i><span>Año Academico</span></a>
                        ...
                        <div class="col-md-8">
                            <table class="table" border="1">
                                ...
                                <thead class="table-success table-striped">
                                    <tr>
                                        <td style="font-family:inherit; font-size: 7">Id</td>
                                        <td style="font-family:inherit; font-size: 7">Tipo Doc</td>
                                        <td style="font-family:inherit; font-size: 7">Nombres</td>
                                        <td style="font-family:inherit; font-size: 7">Apellidos</td>
                                        <td style="font-family:inherit; font-size: 7">Edad</td>
                                        <td style="font-family:inherit; font-size: 7">Fecha Nacimiento</td>
                                        <td style="font-family:inherit; font-size: 7">Genero</td>
                                        <td style="font-family:inherit; font-size: 7">Direccion</td>
                                        <td style="font-family:inherit; font-size: 7">Telefono</td>
                                        <td style="font-family:inherit; font-size: 7">Email</td>
                                        <td style="font-family:inherit; font-size: 7">Id Pais</td>
                                        <td style="font-family:inherit; font-size: 7">Id Ciudad</td>
                                        <td style="font-family:inherit; font-size: 7">Id Curso</td>
                                        <td style="font-family:inherit; font-size: 7">Editar</td>
                                        <td style="font-family:inherit; font-size: 7">Eliminar</td>
                                    </tr>
                                </thead>
                                       ...
                                       while($row=mysqli_fetch_array($query)){
                                        ?>
                                            <tr>
                                                ...
                                                <th style="font-family:hobo; font-size: 10",color:darkred><a href="actualizar1.php?id_est=<?php echo $row['id_est'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:hobo; font-size: 10",color:skyblue><a href="eliminar1.php?id_est=<?php echo $row['id_est'] ?>" class="btn btn-danger">Eliminar</a></th>  
