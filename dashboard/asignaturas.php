...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda"></label><br><a href="ingresarasig.php" class="boton_1" ><style type="text/css">
  .boton_1{
         ...
         <div class="col-md-8">
             <table class="table" border="1">
                <thead class="table-success table-striped" >
                                    <tr>
                                        <td style="font-family:initial; font-size: 9">Id</td>
                                        <td style="font-family:initial; font-size: 9">Nombre Asignatura</td>
                                        <td style="font-family:initial; font-size: 9">Intensidad Horaria</td>
                                        <td style="font-family:initial; font-size: 9">Estado</td>
                                        <td style="font-family:initial; font-size: 9">Id_Area</td>
                                       ...
                                       $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><FONT COLOR="#000000"><?php  echo $row['nom_asig']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['int_horaria']?></FONT></td>
                                                <td><FONT COLOR="#000000"><?php  echo $row['est_asig']?></FONT></td>    
                                                <td><FONT COLOR="#000000"><?php  echo $row['id_area']?></FONT></td>
                                                <th style="font-family:monospace; font-size: 10",color:darkred><a href="actualizarasig.php?id_asig=<?php echo $row['id_asig'] ?>" class="btn btn-warning">Editar</a></th>
                                                <th style="font-family:monospace; font-size: 10",color:skyblue><a href="eliminarasig.php?id_asig=<?php echo $row['id_asig'] ?>" class="btn btn-danger">Eliminar</a></th>  
                                             </tr>                                         
